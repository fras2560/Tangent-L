...
public class ExplainResult {
    public static void main(String[] args) throws IOException{
        ...
        // default arguments
        Path indexDirectory;
        if(formulaLevel == true){
            indexDirectory = Paths.get(System.getProperty("user.dir"), "resources", "index", "wikipedia_formula", "current");
            
        }else{
            indexDirectory = Paths.get(System.getProperty("user.dir"), "resources", "index", "wikipedia", "current");
        }
        Path output = Paths.get(System.getProperty("user.dir"), "resources", "output", "wikipedia_formula", timeStamp + "explain.txt");
        Path queries = Paths.get(System.getProperty("user.dir"), "resources", "query", "NTCIR11-Math-Wikipedia-Sample.xml");
        Path logFile = Paths.get(System.getProperty("user.dir"), "resources", "output", "wikipedia_formula", timeStamp + "explainResults.log");
        ...
        try {
            ...
            // find the score
        } catch (IOException | XPathExpressionException | InterruptedException | ParserConfigurationException | SAXException | ConvertConfigException e) {
