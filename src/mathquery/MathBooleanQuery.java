...
/** A Query that matches documents matching boolean combinations of other
  ...
  * BooleanQuerys.
  */
public class MathBooleanQuery extends Query implements Iterable<BooleanClause> {
  ...
  public static void setMaxClauseCount(int maxClauseCount) {
    ...
    MathBooleanQuery.maxClauseCount = maxClauseCount;
  }
  ...
  public static class Builder {
    ...
    public MathBooleanQuery build() {
      return new MathBooleanQuery(disableCoord, minimumNumberShouldMatch, clauses.toArray(new BooleanClause[0]));
    }
  ...
  private MathBooleanQuery(boolean disableCoord, int minimumNumberShouldMatch,
  ...
  private MathBooleanQuery rewriteNoScoring() {
    MathBooleanQuery.Builder newQuery = new MathBooleanQuery.Builder();
  ...
  public Weight createWeight(IndexSearcher searcher, boolean needsScores) throws IOException {
    MathBooleanQuery query = this;
    if (needsScores == false) {
      query = rewriteNoScoring();
    }
    return new MathWeight(query, searcher, needsScores, disableCoord);
  }
  ...
  private boolean equalsTo(MathBooleanQuery other) {
