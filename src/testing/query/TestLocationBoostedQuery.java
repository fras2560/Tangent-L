...
public class TestLocationBoostedQuery extends TestMathQueryBase{
    private Path folder;
    private Path index;
    ...
    public void setUp() throws Exception{
        ...
        // this.debugLogger();
        this.folder = Paths.get(System.getProperty("user.dir"), "resources", "test", "test_location_boosted");
        ...
        this.config.setBooleanAttribute(ConvertConfig.BOOST_LOCATION, true);
        // delete the index if left over
    ...
    public void testNormal(){
        ...
        expect.put("1", 0.94956934f);
        expect.put("2", 1.5963525f);
